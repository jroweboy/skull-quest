...
const unsigned char skeleton_right_turn[] = {
    -1, 0, 0xdd, 0,
    0, 12, 0xd8, 0 | OAM_FLIP_H,
    0, 5, 0xd9, 0 | OAM_FLIP_H,
    -8, 4, 0xdc, 0 | OAM_FLIP_H,
    128

};

const unsigned char skeleton_left_still[] = {
    -1, 0, 0xdd, 0 | OAM_FLIP_H,
    0, 12, 0xd8, 0 | OAM_FLIP_H,
    0, 5, 0xd9, 0 | OAM_FLIP_H,
    -8, 4, 0xdc, 0 | OAM_FLIP_H,
    128
...
const unsigned char skeleton_left_walk1[] = {
    -1, -1, 0xdd, 0 | OAM_FLIP_H,
    0, 12, 0xda, 0 | OAM_FLIP_H,
    0, 4, 0xd9, 0 | OAM_FLIP_H,
    -8, 3, 0xdc, 0 | OAM_FLIP_H,
    128

};

const unsigned char skeleton_left_walk2[] = {
    -2, 0, 0xdd, 0 | OAM_FLIP_H,
    0, 12, 0xdb, 0 | OAM_FLIP_H,
    -1, 5, 0xd9, 0 | OAM_FLIP_H,
    -9, 4, 0xdc, 0 | OAM_FLIP_H,
    128

};

const unsigned char skeleton_left_walk3[] = {
    -1, 12, 0xde, 0 | OAM_FLIP_H,
    -1, 4, 0xd9, 0 | OAM_FLIP_H,
    -9, 2, 0xdc, 0 | OAM_FLIP_H,
    -2, -1, 0xdd, 0 | OAM_FLIP_H,
    128

};

const unsigned char skeleton_left_walk4[] = {
    0, 12, 0xdf, 0 | OAM_FLIP_H,
    0, 5, 0xd9, 0 | OAM_FLIP_H,
    -8, 3, 0xdc, 0 | OAM_FLIP_H,
    -1, 0, 0xdd, 0 | OAM_FLIP_H,
    128
...
const unsigned char skeleton_dying_right5[] = {
    ...
    1, 12, 0xdf, 0,
    9, 12, 0xdc, 0,
    6, 9, 0xdd, 0 | OAM_FLIP_H | OAM_FLIP_V,
    128};
...
const unsigned char skeleton_dying_right7[] = {
    ...
    1, 12, 0xdf, 0,
    9, 12, 0xdc, 0,
    9, 12, 0xdd, 0 | OAM_FLIP_V,
    128};

const unsigned char skeleton_dying_left1[] = {
    1, 12, 0xdf, 0 | OAM_FLIP_H,
    1, 7, 0xd9, 0 | OAM_FLIP_H,
    -7, 4, 0xdc, 0 | OAM_FLIP_H,
    0, 0, 0xdd, 0 | OAM_FLIP_H,
    128};

const unsigned char skeleton_dying_left2[] = {
    1, 9, 0xd9, 0 | OAM_FLIP_H,
    1, 12, 0xdf, 0 | OAM_FLIP_H,
    -7, 6, 0xdc, 0 | OAM_FLIP_H,
    0, 1, 0xdd, 0 | OAM_FLIP_H,
    128};

const unsigned char skeleton_dying_left3[] = {
    1, 11, 0xd9, 0 | OAM_FLIP_H,
    1, 12, 0xdf, 0 | OAM_FLIP_H,
    -7, 8, 0xdc, 0 | OAM_FLIP_H,
    0, 3, 0xdd, 0 | OAM_FLIP_H,
    128};

const unsigned char skeleton_dying_left4[] = {
    2, 12, 0xd9, 0 | OAM_FLIP_H,
    1, 12, 0xdf, 0 | OAM_FLIP_H,
    -7, 12, 0xdc, 0 | OAM_FLIP_H,
    0, 7, 0xdd, 0 | OAM_FLIP_H,
    128};

const unsigned char skeleton_dying_left5[] = {
    3, 12, 0xd9, 0 | OAM_FLIP_H,
    1, 12, 0xdf, 0 | OAM_FLIP_H,
    -7, 12, 0xdc, 0 | OAM_FLIP_H,
    -4, 9, 0xdd, 0 | OAM_FLIP_V,
    128};

const unsigned char skeleton_dying_left6[] = {
    4, 12, 0xd9, 0 | OAM_FLIP_H,
    1, 12, 0xdf, 0 | OAM_FLIP_H,
    -7, 12, 0xdc, 0 | OAM_FLIP_H,
    -5, 12, 0xdd, 0 | OAM_FLIP_H,
    128};
...
const unsigned char skeleton_dying_left7[] = {
    ...
    1, 12, 0xdf, 0 | OAM_FLIP_H,
    -7, 12, 0xdc, 0 | OAM_FLIP_H,
    -7, 12, 0xdd, 0 | OAM_FLIP_H | OAM_FLIP_V,
    128};
