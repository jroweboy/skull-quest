...
@REM USE_BANKED_DPCM - enable if you want to setup the MMC3 to bank $c000 to allow for more than 16k of samples
...
set defines=USE_BANKED_DPCM USE_CHR_A12_INVERT USE_FAMISTUDIO
...
cl65 %defines_concatted% -Oirs -g -C %cfg% -t nes --add-source -Ln %out%\labels.txt -o %out%\%name%.nes %srcs%
