...
.if !.defined(MMC3_BANK_FLAGS)
	MMC3_BANK_FLAGS .set 0
	.ifdef USE_BANKABLE_DPCM
		MMC3_BANK_FLAGS .set MMC3_BANK_FLAGS | BANKED_DPCM_FLAG
	.endif
	.ifdef USE_CHR_A12_INVERT
		MMC3_BANK_FLAGS .set MMC3_BANK_FLAGS | A12_INVERT
	.endif
.endif
