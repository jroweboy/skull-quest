...
;
	lda     #$09
	jsr     pusha
	lda     #<(_gate_animation_index)
	ldx     #>(_gate_animation_index)
	jsr     _set_animation_info
;
...
;
	jsr     pusha
	lda     #<(_house_door_animation_index)
	ldx     #>(_house_door_animation_index)
	jsr     _set_animation_info
;
...
;
	lda     #$06
	jsr     pusha
	lda     #<(_devil_animation_index)
	ldx     #>(_devil_animation_index)
	jsr     _set_animation_info
;
