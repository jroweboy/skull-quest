...
; ---------------------------------------------------------------
; void __near__ init_levels_data (void)
; ---------------------------------------------------------------

.segment	"BANK0"

.proc	_init_levels_data: near
...
;
	ldx     #$00
L002B:	lda     _current_level
	asl     a
	bcc     L0016
	inx
	clc
L0016:	adc     #<(_levels+50)
	sta     ptr1
	txa
	adc     #>(_levels+50)
	sta     ptr1+1
...
;
	lda     #$00
	jsr     pusha
	lda     #<(_init_levels_data)
	ldx     #>(_init_levels_data)
	jsr     _banked_call
;
