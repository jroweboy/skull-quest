...
; ---------------------------------------------------------------
; void __near__ first_hit (void)
; ---------------------------------------------------------------

.segment	"CODE"

.proc	_first_hit: near
...
; temp = get_inactive_actor_index();
;
L0024:	jsr     _get_inactive_actor_index
	sta     _temp
;
; if (temp) {
;
